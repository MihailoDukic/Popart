...
var openNav = document.querySelector('.header__container__open-menu');
var closeNav = document.querySelector('.header__container__mobile-nav__close-menu');

function openMenu() {
  var menu = gsap.timeline();
  menu.to('body', {});
  menu.to('.header__container__mobile-nav', {
    opacity: 1,
    visibility: 'visible'
  });
  menu.to('.link-anime', {
...
;
toggleLinks();
},{"./swiper":"js/swiper.js"}],"js/gsap.min.js":[function(require,module,exports) {
var define;
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var _gsap = _interopRequireDefault(require("./gsap.min"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./app":"js/app.js","./gsap.min":"js/gsap.min.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
